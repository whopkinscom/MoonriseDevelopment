...
namespace Moonrise.Utils.Standard.Misc
{
    ...
    public class Recursion : IDisposable
    {
        ...
        /// </summary>
        private static readonly ThreadLocal<int> currentDepth = new ThreadLocal<int>();
        ...
        /// </summary>
        /// <remarks>
        ///     As long as the using pattern is deployed the count will always get reset to zero, either by an exception or returns
        ///     falling down the stack.
        /// </remarks>
        public void Dispose()
        {
            currentDepth.Value--;
        ...
        ///     The maximum depth you do not expect to exceed - defaults to 50. It's pretty rare to go much
        ///     deeper than this but you know your algorithm!
        /// </param>
