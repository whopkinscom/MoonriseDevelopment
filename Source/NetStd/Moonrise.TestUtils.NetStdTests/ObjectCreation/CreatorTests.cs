...
namespace Moonrise.TestUtils.Tests
{
    ...
    public class CreatorTests
    {
        ...
        {
            [RegularExpression("(\\W|^)[\\w.\\-]{0,25}@(yahoo|hotmail|gmail)\\.com(\\W|$)")]
            public string StringOne { get; set; }
            [RegularExpression("192\\.168\\.1\\.\\d{1,3}")]
        ...
        {
            Creator creator = new();
            creator.RespectValidation = true;
            Strings strings = creator.CreateFilled<Strings>();
