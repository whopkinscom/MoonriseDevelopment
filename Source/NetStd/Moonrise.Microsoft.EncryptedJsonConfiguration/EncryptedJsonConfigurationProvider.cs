...
namespace Moonrise.Microsoft.Extensions.Configuration.EncryptedJsonConfiguration
{
    ...
    public class EncryptedJsonConfigurationProvider : JsonConfigurationProvider
    {
        ...
        ///     that application to also be able to use the <see cref="IConfiguration" /> access, then you must use
        ///     <see cref="AdditionalEntropy" /> to pass/smuggle that
        ///     value down to enable it to decrypt. You must do this prior to every call against the <see cref="IConfiguration" />.
