...
namespace Moonrise.StandardUtils.Tests.Config
{
    ...
    public class JsonConfigSettingsProviderTests
    {
        ...
        public void AccessByContext()
        {
            ...
            JsonConfigSettingsProvider provider = new JsonConfigSettingsProvider("Config\\appsettings.json");
//            JsonConfigSettingsProvider provider = new JsonConfigSettingsProvider("Config\\appsettings.json", "..\\..\\Config", null);
